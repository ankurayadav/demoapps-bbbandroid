...
jint Java_com_bbbandroidHAL_adc_MainActivity_readADC(JNIEnv *env, jobject this, jint channel)
{
	jint ret;
	ret = readADC(channel) ;
...
jint Java_com_bbbandroidHAL_i2c_MainActivity_i2cOpenAdaptor(JNIEnv *env, jobject this, jint adaptorNumber)
{
	jint ret;
...
jboolean Java_com_bbbandroidHAL_i2c_MainActivity_i2cSetSlave(JNIEnv *env, jobject this, jint i2cFD, jint address)
{
	jint ret;
...
void Java_com_bbbandroidHAL_i2c_MainActivity_i2cClose(JNIEnv *env, jobject this, jint i2cFD)
{
	i2cClose(i2cFD) ;
